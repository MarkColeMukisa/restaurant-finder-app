            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute top-4 left-4">
                  <div className="bg-orange-600 text-white px-3 py-1 rounded-full text-sm font-semibold backdrop-blur-sm">
              ...
              <div className="p-4">
                <div className="flex flex-wrap gap-2">
                  {destination.featured?.map((tag, index) => (
                    <span
                      key={index}
                      className="inline-block bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-xs font-medium hover:bg-orange-50 hover:text-orange-600 transition-colors duration-200"
                    >
                      {tag}
                    </span>
                  ))}
