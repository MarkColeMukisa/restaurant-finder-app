      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
            Popular <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-red-600">Restaurants</span>
          </h2>
            ...
            >
              ...
              <div className="p-4 flex flex-col flex-grow">
                ...
                <Link href={`/restaurants/${restaurant.id}`} className="w-full">
                  <button className="w-full px-4 py-2 bg-gradient-to-r from-orange-600 to-red-600 text-white font-semibold rounded-lg hover:from-orange-700 hover:to-red-700 transition-all duration-300 transform hover:scale-105 shadow-md text-sm">
                    View Details
                  </button>
                </Link>
              </div>
